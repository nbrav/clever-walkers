...
public class QAgent : MonoBehaviour
{
    ...
    float[,,] state_array;
    float[] radius_annulus = new float[] {2.5f,5.0f,7.5f,10.0f};
   ...
   /* --------------------
    ...
    public void reset()
    {
      transform.position = defaultLocation; //new Vector3(UnityEngine.Random.Range(-10,10),0,UnityEngine.Random.Range(-10,10));
